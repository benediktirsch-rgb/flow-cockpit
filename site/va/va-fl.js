...
(function(){
  ...
  css.textContent=[
    ...
    /* Abzeichen als Pille — Kartenlayout der Porsche-Team-Liga (pb-fl2.js .fl2-b), auf Vishnu-Tokens uebertragen */
    '.vfl-b{display:inline-flex;align-items:center;gap:5px;border:1px solid var(--line,#e2e4e5);border-radius:14px;padding:3px 10px 3px 7px;font-size:11px;font-weight:700;background:var(--card,#fff);color:var(--ink,#0f1010);margin:1px 3px 1px 0;white-space:nowrap} .vfl-b .ic{font-size:13px}',
    '.vfl-lb{border:1px solid var(--line,#e2e4e5);border-radius:10px;overflow:hidden;background:var(--card,#fff)} .vfl-lb .r{display:flex;align-items:center;gap:10px;padding:8px 12px;border-bottom:1px dashed var(--line,#e2e4e5);font-size:12.5px} .vfl-lb .r:last-child{border-bottom:0} .vfl-lb .r.me{background:rgba(137,197,39,.10)} .vfl-lb .rk{width:26px;font-weight:800;text-align:center} .vfl-lb .nm{flex:1;font-weight:700;min-width:0} .vfl-lb .bd{font-size:11px;color:var(--sub,#5f6668);font-weight:400} .vfl-lb .m{font-size:11px;color:var(--sub,#5f6668);white-space:nowrap} .vfl-lb .sc{font-weight:800;min-width:44px;text-align:center;background:var(--bg,#f7f8f4);border-radius:10px;padding:3px 0;color:var(--brand-dark,#5c9220);font-size:13px}',
  ...
  function badgesHtml(b){ return b.map(function(x){return '<span class="vfl-b" title="'+E(x[2])+'"><span class="ic">'+x[0]+'</span>'+E(x[1])+'</span>';}).join(''); }
